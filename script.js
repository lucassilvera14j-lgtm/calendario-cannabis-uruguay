document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCalendar() {
        ...
        // Obtener las fases del objeto REAL_MOON_PHASES
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            // Marcar las fases lunares si existen datos para el mes
    ...
    function initializeMoonSelectors() {
        ...
        // Cargar solo el año 2025 (disponible en REAL_MOON_PHASES)
    ...
    // FUNCIÓN DE BÚSQUEDA LUNAR UTILIZANDO LOS DATOS REALES
    function searchMoonPhases() {
        ...
        // Obtener los datos lunares específicos para el año y mes seleccionados
        ...
        phasesForSelectedMonth.forEach(phase => {
            ...
            // Construimos la fecha completa para mostrarla
